...
/**
 * Exceptions of this class are thrown by MongoClientMediator and MongoClientConsumer
 * when login into the database was not possible; usually due to invalid username
 * or password.
 */
