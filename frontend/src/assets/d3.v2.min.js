(function() {
  ...
  function by(a, b) {
    function f() {
      ...
      (c.lastIndex = 0),
        c.test(e) ||
          ((e = w(e + ' ' + a)), d ? (b.baseVal = e) : (this.className = e));
    }
    function g() {
          ...
          return (
            a.each(function(h, i, j) {
              ...
              function q(a) {
                ...
                if (c >= 1)
                  return r(), (bL = b), e.end.call(l, h, i), (bL = 0), 1;
              }
              function r() {
  ...
  function bS(a) {
    ...
    for (var f = 0, g = this.length; f < g; f++)
      for (var h = this[f], i = 0, j = h.length; i < j; i++) {
        ...
        k &&
          ((bP = this[f][i].delay),
          (bQ = this[f][i].duration),
          a.call((k = k.node), k.__data__, i, f));
      }
  ...
  function bW() {
    ...
    var d = bX() - b;
    d > 24
      ? (isFinite(d) && (clearTimeout(bV), (bV = setTimeout(bW, d))), (bU = 0))
      : ((bU = 1), bY(bW));
  }
  function bX() {
    var a = null,
  ...
  function bZ(a) {
    ...
    b[0] * c[1] < c[0] * b[1] &&
      ((b[0] *= -1), (b[1] *= -1), (d *= -1), (e *= -1)),
      (this.rotate =
        (d ? Math.atan2(b[1], b[0]) : Math.atan2(-c[0], c[1])) * cb),
      (this.translate = [a.e, a.f]),
      (this.scale = [d, f]),
      (this.skew = f ? Math.atan2(e, f) * cb : 0);
  }
  function b$(a, b) {
  ...
  function co(a, b) {
    return d3.format(
      ',.' +
        Math.max(0, -Math.floor(Math.log(cm(a, b)[2]) / Math.LN10 + 0.01)) +
        'f'
    );
  }
  function cp(a, b, c, d) {
  ...
  function cr(a, b) {
    ...
    return (
      ...
      (d.domain = function(e) {
        return arguments.length
          ? ((b = e[0] < 0 ? cu : ct), (c = b.pow), a.domain(e.map(b)), d)
          : a.domain().map(c);
      }),
      (d.nice = function() {
  ...
  function cY(a) {
    ...
    de(i, g, h);
    while (++b < c)
      (d = a[b]), g.shift(), g.push(d[0]), h.shift(), h.push(d[1]), de(i, g, h);
    b = -1;
    while (++b < 2)
      g.shift(), g.push(d[0]), h.shift(), h.push(d[1]), de(i, g, h);
    return i.join('');
  }
  function cZ(a) {
    ...
    while (++c < d)
      (e = a[c]), f.shift(), f.push(e[0]), g.shift(), g.push(e[1]), de(b, f, g);
    return b.join('');
  }
  function c$(a) {
    var b,
        ...
        for (var m = 3; m < f; m++) {
          ...
          if (n == 1)
            for (k = g._pack_prev; k !== j._pack_prev; k = k._pack_prev, p++)
              if (eo(k, i)) break;
          n
            ? (o < p || (o == p && h.r < g.r) ? en(g, (h = j)) : en((g = k), h),
              m--)
            : (em(g, i), (h = i), l(i));
        }
      }
  ...
  function fb(a, b) {
    function q(a) {
      ...
      return [
        Math.atan2(i, f) / eO,
        Math.atan2(l, Math.sqrt(f * f + i * i)) / eO,
      ];
    }
    var c = a[0] * eO,
      d = Math.cos(c),
      ...
      n = Math.sin(l),
      o = (q.d = Math.acos(
        Math.max(-1, Math.min(1, h * n + g * m * Math.cos(i - c)))
      )),
      p = Math.sin(o);
    return q;
  }
  ...
  (d3.map = function(a) {
    ...
    e(k, {
      ...
      forEach: function(a) {
        for (var b in this)
          b.charCodeAt(0) === m && a.call(this, b.substring(1), this[b]);
      },
    });
  var l = '\0',
    m = l.charCodeAt(0);
  ...
  (d3.bisectLeft = u.left),
    (d3.bisect = d3.bisectRight = u.right),
    ...
    (d3.nest = function() {
      function f(c, g) {
        ...
        var h = -1,
          ...
          p = {};
        while (++h < i)
          (o = n.get((l = j((m = c[h]))))) ? o.push(m) : n.set(l, [m]);
        return (
  ...
  (d3.ns = {
    ...
    qualify: function(a) {
      ...
      return (
        ...
        z.hasOwnProperty(c) ? { space: z[c], local: a } : a
      );
    },
  }),
  ...
  (d3.ease = function(a) {
    ...
    return (
      (c = M.get(c) || L),
      (d = N.get(d) || R),
      O(d(c.apply(null, Array.prototype.slice.call(arguments, 1))))
    );
  }),
    (d3.event = null),
  ...
  (d3.interpolators = [
    ...
    function(a, b) {
      return (
        (typeof b == 'string'
          ? bk.has(b) || /^(#|rgb\(|hsl\()/.test(b)
          : b instanceof bf || b instanceof bm) && d3.interpolateRgb(a, b)
      );
    },
    function(a, b) {
  ...
  bk.forEach(function(a, b) {
    ...
    (bm.prototype.brighter = function(a) {
      return (
        (a = Math.pow(0.7, arguments.length ? a : 1)),
        bl(this.h, this.s, this.l / a)
      );
    }),
    (bm.prototype.darker = function(a) {
      return (
        (a = Math.pow(0.7, arguments.length ? a : 1)),
        bl(this.h, this.s, a * this.l)
      );
    }),
  ...
  var bp = function(a, b) {
    ...
    bs =
      br.matchesSelector ||
      br.webkitMatchesSelector ||
      br.mozMatchesSelector ||
      br.msMatchesSelector ||
      br.oMatchesSelector,
    bt = function(a, b) {
      return bs.call(a, b);
    };
  ...
  (d3.selection = function() {
    ...
    (d3.selection.prototype = bu),
    (bu.select = function(a) {
      var b = [],
        c,
        d,
        e,
    ...
    (bu.selectAll = function(a) {
      ...
      for (var e = -1, g = this.length; ++e < g; )
        for (var h = this[e], i = -1, j = h.length; ++i < j; )
          if ((d = h[i]))
            b.push((c = f(a.call(d, d.__data__, i)))), (c.parentNode = d);
      return bo(b);
    }),
    ...
    (bu.transition = function() {
      ...
      for (var d = -1, e = this.length; ++d < e; ) {
        ...
        for (var f = this[d], g = -1, h = f.length; ++g < h; )
          b.push((c = f[g]) ? { node: c, delay: bP, duration: bQ } : null);
      }
  ...
  var bE = [];
  (d3.selection.enter = bD),
    (d3.selection.enter.prototype = bE),
    (bE.append = bu.append),
    (bE.insert = bu.insert),
    (bE.empty = bu.empty),
    (bE.node = bu.node),
    (bE.select = function(a) {
      var b = [],
        c,
        d,
        e,
  ...
  (bJ.call = bu.call),
    ...
    (d3.transition.prototype = bJ),
    (bJ.select = function(a) {
      var b = [],
        c,
        d,
        e;
  ...
  (d3.timer = function(a, b, c) {
    ...
    d || (bT = { callback: a, then: c, delay: b, next: bT }),
    ...
    function k(k) {
      k.each(function() {
        ...
        (this.__chart__ = B),
          ...
          t.append('text'),
          v.select('text').text(m);
        switch (b) {
          case 'bottom':
            (w = dz),
              p.attr('y2', d),
              r.attr('x2', 0).attr('y2', d),
              t.select('line').attr('y2', c),
              t.select('text').attr('y', Math.max(c, 0) + f),
              v
                .select('line')
                .attr('x2', 0)
                .attr('y2', c),
          ...
          case 'left':
            (w = dA),
              ...
              t.select('line').attr('x2', -c),
              t.select('text').attr('x', -(Math.max(c, 0) + f)),
              v
                .select('line')
                .attr('x2', -c)
                .attr('y2', 0),
      ...
      function g(a) {
        a.each(function() {
          ...
          a
            ...
            l.exit().remove(),
            b &&
              ((m = cg(b)), e.attr('x', m[0]).attr('width', m[1] - m[0]), i(a)),
            c &&
              ((m = cg(c)),
  ...
  (d3.behavior = {}),
    (d3.behavior.drag = function() {
      ...
      function d() {
        ...
        function l() {
          d({ type: 'dragend' }),
            h && (Z(), d3.event.target === e && i.on('click.drag', m, !0)),
            i
    ...
    (d3.layout.force = function() {
      ...
      return (
        (a.tick = function() {
          ...
          for (h = 0; h < d; ++h) {
            (k = o[h]),
              ...
              (w = n.y - l.y);
            if ((q = v * v + w * w))
              (q = (e * r[h] * ((q = Math.sqrt(q)) - p[h])) / q),
                (v *= q),
                (w *= q),
                (n.x -= v * (u = l.weight / (n.weight + l.weight))),
                (n.y -= w * u),
                (l.x += v * (u = 1 - u)),
                (l.y += w * u);
          }
        ...
        (a.start = function() {
          ...
          for (b = 0; b < f; ++b)
            (n = o[b]),
              typeof n.source == 'number' && (n.source = m[n.source]),
              typeof n.target == 'number' && (n.target = m[n.target]),
              (p[b] = g.call(this, n, b)),
              (r[b] = h.call(this, n, b)),
              ++n.source.weight,
              ++n.target.weight;
        ...
        (a.drag = function() {
          d ||
            (d = d3.behavior
              ...
              .on('drag', dP)
              .on('dragend', dO)),
            this.on('mouseover.force', dM)
              .on('mouseout.force', dN)
              .call(d);
        }),
        d3.rebind(a, b, 'on')
      );
    ...
    (d3.layout.pie = function() {
      function f(g, h) {
        var i = g.map(function(b, c) {
          ...
          k =
            ((typeof e == 'function' ? e.apply(this, arguments) : e) - c) /
            d3.sum(i),
          l = d3.range(g.length);
        b != null &&
          l.sort(
  ...
  d3.layout.stack = function() {
    ...
    return (
      ...
      (g.order = function(a) {
        return arguments.length
          ? ((b = typeof a == 'function' ? a : dX.get(a) || dZ), g)
          : b;
      }),
      (g.offset = function(a) {
        return arguments.length
          ? ((c = typeof a == 'function' ? a : dY.get(a) || d$), g)
          : c;
      }),
      (g.x = function(a) {
      ...
      function e(f, h, i) {
        ...
        if (j && (m = j.length)) {
          var l = -1,
            ...
            p = h + 1;
          while (++l < m)
            (d = e(j[l], p, i)), (d.parent = k), n.push(d), (o += d.value);
        ...
        function j(a, c, d) {
          if (c) {
            var e = a,
              ...
              l = h._tree.mod,
              m;
            while (((g = eB(g)), (e = eA(e)), g && e))
              (h = eA(h)),
                (f = eB(f)),
                (f._tree.ancestor = a),
                (m = g._tree.prelim + k - e._tree.prelim - i + b(g, e)),
                m > 0 && (eI(eJ(g, a, d), a, m), (i += m), (j += m)),
                (k += g._tree.mod),
                (i += e._tree.mod),
                (l += h._tree.mod),
                (j += f._tree.mod);
            g && !eB(f) && ((f._tree.thread = g), (f._tree.mod += k - j)),
              e &&
                !eA(h) &&
      ...
      return (
        ...
        (n.padding = function(a) {
          function b(b) {
            ...
            return c == null
              ? eK(b)
              : eL(b, typeof c == 'number' ? [c, c, c, c] : c);
          }
          function c(b) {
            return eL(b, a);
          }
  ...
  (d3.geo.azimuthal = function() {
    ...
    return (
      (i.invert = function(b) {
        var f = (b[0] - d[0]) / c,
          ...
          m = Math.cos(k);
        return [
          (e + Math.atan2(f * l, j * g * m + i * h * l)) / eO,
          Math.asin(m * h - (j ? (i * l * g) / j : 0)) / eO,
        ];
      }),
      (i.mode = function(b) {
    ...
    (d3.geo.path = function() {
      function d(c, d) {
        return (
          typeof a == 'function' && (b = eQ(a.apply(this, arguments))),
          f(c) || null
        );
      }
      function e(a) {
  ...
  (d3.geo.circle = function() {
    ...
    function h(a) {
      ...
      return (
        h &&
          f.length &&
          ((l = d.distance((j = f[0]))), f.push(fb(h, j)((k - c) / (k - l)))),
        i(f)
      );
    }
    function i(a) {
    ...
    e.clip = function(b) {
      return (
        d.source(typeof a == 'function' ? a.apply(this, arguments) : a), g(b)
      );
    };
    var g = eP({
      FeatureCollection: function(a) {
  ...
  var fr = d3.format('02d'),
    ...
    fF = /^(?:January|February|March|April|May|June|July|August|September|October|November|December)/gi,
    fG = d3.map({
      january: 0,
      february: 1,
      march: 2,
